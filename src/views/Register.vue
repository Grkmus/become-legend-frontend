          ...
          <fieldset>
            ...
            <div class="form-group has-danger">
              ...
              <input
                v-model="player.name"
                id="name"
                v-bind:class="{ 'is-invalid': errorMessage.name }"
                class="form-control"
                type="text"
                placeholder="Name"
                name="name"
            ...
            <div class="form-group has-danger">
              ...
              <input
                ...
                id="surname"
                v-bind:class="{ 'is-invalid': errorMessage.surname }"
                class="form-control"
                type="text"
                placeholder="Surname"
                name="surname"
            ...
            <div class="form-group has-danger">
              ...
              <input
                ...
                id="email"
                v-bind:class="{ 'is-invalid': errorMessage.email }"
                class="form-control"
                type="email"
            ...
            <div class="form-group has-danger">
              ...
              <input
                ...
                id="usernameId"
                v-bind:class="{ 'is-invalid': errorMessage.username }"
                class="form-control"
                type="text"
                placeholder="name"
                name="username"
            ...
            <div class="form-group">
              ...
              <input
                ...
                id="pw"
                v-bind:class="{ 'is-invalid': errorMessage.password }"
                class="form-control"
                type="password"
            ...
            <div class="form-group">
              ...
              <input
                ...
                id="cpw"
                v-bind:class="{ 'is-invalid': errorMessage.confirmPassword }"
                class="form-control"
                type="password"
