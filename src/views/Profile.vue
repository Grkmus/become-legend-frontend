  ...
  <div class="container">
    <div class="card">
      <div class="row no-gutters">
        <div class="col-md-4">
          <img
            src="https://www.mercurynews.com/wp-content/uploads/2018/09/BNG-L-WARRIORS-0925-131.jpg?w=525"
            class="card-img"
            alt="..."
          />
        </div>
        <div class="col-md-8">
          <div class="card-body">
            ...
            <a
              ...
              :href="'/player/' + player.id + '/quiz'"
            >Fill out the quick form to play basketball!</a>
          </div>
        </div>
      </div>
    </div>
